...
public class Popup extends BaseScreenHandler {
    ...
    public Popup(Stage stage) throws IOException{
        super(stage, ViewsConfig.POPUP_PATH);
    }

    private static Popup popup(String message, String imagePath, Boolean undecorated) throws IOException{
        Popup popup = new Popup(new Stage());
    ...
    public static Popup loading(String message) throws IOException{
