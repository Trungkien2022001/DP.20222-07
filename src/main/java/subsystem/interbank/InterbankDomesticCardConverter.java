 ...
 * @author
 */
public class InterbankDomesticCardConverter {
     ...
     * @return
     */
    String convertToRequestPayload(DomesticCard card, int amount, String contents) {
    ...
    PaymentTransaction extractPaymentTransaction(String responseText) {
        ...
        DomesticCard card = new DomesticCard(
                (String) transaction.get("cardHolder"),
                (String) transaction.get("type"),
                (String) transaction.get("validFromDate"),
                   (String) transaction.get("issuingBank"),
                Integer.parseInt((String) transaction.get("cardNumber")));
